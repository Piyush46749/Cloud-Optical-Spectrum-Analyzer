...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AppComponent = /*#__PURE__*/function () {
      ...
      _createClass(AppComponent, [{
        ...
        value: function onClickSingleTrace(Source) {
          var _this = this;

          this.service.getSingleTrace().subscribe(function (resdata) {
            if (typeof resdata['data'] != 'string' && resdata['code'] == 200) {
              if (Source == 'INTERVAL' && !_this.isInterval) return;
              _this.communicationText += new Date() + '-> Graph plotted for the trace...\n';
              var xData = resdata['data']['xdata'];
              var yData = resdata['data']['ydata'];
              var lineColor = _this.lineColors[0];

              if (xData.length != 0 && yData.length != 0) {
                _this.communicationText += new Date() + '-> Data fetched... \n';

                _this.renderChart(xData, yData, lineColor);
              } else if (_this.persistDataOption == 'Y') {
                _this.communicationText += new Date() + '-> Overlay successive plots is enabled but no data is received...\n';
                _this.communicationText += new Date() + '-> Again trying to fetch data!...\n';

                _this.onClickSingleTrace('notInterval');
              } else {
                _this.communicationText += new Date() + '-> Overlay successive plot is disabled, no data received...\n';
              }
            } else {
              _this.communicationText += new Date() + '-> Invalid response received, please reload the page...\n';
            }
          });
        }
      }, {
        key: "onClickPersistDataOption",
        value: function onClickPersistDataOption(option) {
        ...
        value: function onClickGetData() {
          ...
          this.communicationText += new Date() + '-> User queried : ' + this.logic + ' \n';
          this.service.getRequestData(payload).subscribe(function (resdata) {
            if (resdata['code'] == 200) {
              _this2.requestOutput = resdata['data'];

              if (_this2.isValidJSON(_this2.requestOutput)) {
                _this2.requestOutput = JSON.parse(_this2.requestOutput);
              }
            }
          });
        }
        ...
        value: function renderChart(xData, yData, lineColor) {
          ...
          if (this.persistDataOption == 'N') {
            ...
            if (this.numberOfLayers > this.maxNumberOfLayers) {
              var color = this.chartData[0]['lineColor'];
        ...
        value: function onClickStartStop(clickType) {
          ...
          if (clickType == 'START') {
            ...
            this.poller = setInterval(function (_) {
              _this3.onClickSingleTrace('INTERVAL');
            }, 1000);
          } else {
            this.isInterval = false;
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_button_click_7_listener() {
            return ctx.onClickSingleTrace("notInterval");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_input_ngModelChange_17_listener($event) {
            ...
            return ctx.onClickPersistDataOption("Y");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_input_ngModelChange_20_listener($event) {
            ...
            return ctx.onClickPersistDataOption("N");
          });
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("disabled", ctx.isInterval);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngModel", ctx.logic);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](9);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](ctx.communicationText);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](41, 8, ctx.requestOutput));
        }
      },
      ...
      styles: [".jumbotron[_ngcontent-%COMP%] {\n  padding: 30px;\n  text-align: center;\n  background: black;\n  color: #D68910;\n  font-size: 25px;\n  font-family: Arial, Helvetica, sans-serif;\n  font-weight: bold;\n  font-variant: small-caps;\n  text-decoration: underline;\n  border: 2px solid black;\n  box-shadow: 10px 10px 8px #888888;\n}\n\n\n\n\n\n.chart-view[_ngcontent-%COMP%] {\n  height: 650px;\n  width: 85%;\n  overflow: hidden;\n  border: 2px solid black;\n  box-shadow: 10px 10px 8px #888888;\n}\n\n.action-container[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  \n  align-items: center;\n  width: 14%;\n  color: black;\n  text-align: center;\n  font-weight: 1000;\n}\n\n\n\n.query-output[_ngcontent-%COMP%] {\n  margin-top: 10px;\n  background-color: black;\n  color: rgb(9, 146, 32);\n  border: 2px solid black;\n  box-shadow: 10px 10px 8px #888888;\n  height: 400px;\n  overflow: hidden;\n  overflow-y: scroll;\n}\n\n.cmd-container[_ngcontent-%COMP%]{\n  width: 90%;\n\n}\n\n.log-container[_ngcontent-%COMP%] {\n  width: 90%;\n\n}\n\n.logs-output[_ngcontent-%COMP%] {\n    border: 2px solid black;\n    box-shadow: 10px 10px 8px #888888;\n    overflow-y: scroll;\n    height: 400px;\n    padding: 0px 10px;\n    background-color: black;\n    color: rgb(9, 146, 32);\n}\n\n.chart_button[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: row;\n  \n  }\n\n.chart_button[_ngcontent-%COMP%]    > div[_ngcontent-%COMP%] {\n  margin: 0.5%;\n  margin-top: 1.3%;\n\n}\n\n.log_cmd[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: row;\n}\n\n.log_cmd[_ngcontent-%COMP%]    > div[_ngcontent-%COMP%] {\n  flex: 1;\n  margin: 10px;\n}\n\n.single_button[_ngcontent-%COMP%] {\n  background-color:#4CAF50;\n  color: rgb(255, 255, 255);\n  width: 150px;\n  padding: 20px 20px;\n  margin-bottom: 10px;\n  font-family: Arial, Helvetica, sans-serif;\n  font-weight: bold;\n  font-size: medium;\n}\n\n.single_button[_ngcontent-%COMP%]:hover {\n  border: 2px solid black;\n    box-shadow: 3px 3px 3px #2C3E50;\n    background-color: rgb(9, 146, 32);\n}\n\n.start_button[_ngcontent-%COMP%] {\n  background-color: #008CBA;\n  color: #FFFFFF;\n  width: 150px;\n  padding: 20px 20px;\n  margin-bottom: 10px;\n  font-family: Arial, Helvetica, sans-serif;\n  font-weight: bold;\n  font-size: medium;\n}\n\n.start_button[_ngcontent-%COMP%]:hover {\n  border: 2px solid black;\n    box-shadow: 3px 3px 3px #2C3E50;\n    background-color: rgb(6, 106, 139);\n}\n\n.stop_button[_ngcontent-%COMP%] {\n  background-color: #f44336;\n  color: #FFFFFF;\n  width: 150px;\n  padding: 20px 20px;\n  margin-bottom: 10px;\n  font-family: Arial, Helvetica, sans-serif;\n  font-weight: bold;\n  font-size: medium;\n}\n\n.stop_button[_ngcontent-%COMP%]:hover {\n  border: 2px solid black;\n    box-shadow: 3px 3px 3px #2C3E50;\n    background-color: #c2251a;\n}\n\n.cmd_button[_ngcontent-%COMP%] {\n  background-color:#4CAF50;\n  color: rgb(255, 255, 255);\n  width: 150px;\n  padding: 20px 20px;\n  font-family: Arial, Helvetica, sans-serif;\n  font-weight: bold;\n  font-size: medium;\n}\n\n.cmd_button[_ngcontent-%COMP%]:hover {\n  border: 2px solid black;\n    box-shadow: 3px 3px 3px #2C3E50;\n    background-color: rgb(9, 146, 32);\n}\n\n#query_heading[_ngcontent-%COMP%] {\n  color: black;\n  font-weight: bold;\n  font-size: x-large;\n  font-family: Arial, Helvetica, sans-serif;\n  font-variant: small-caps;\n  text-decoration: underline;\n}\n\n#log_heading[_ngcontent-%COMP%] {\n  color: black;\n  font-weight: bold;\n  font-size: x-large;\n  font-family: Arial, Helvetica, sans-serif;\n  font-variant: small-caps;\n  text-decoration: underline;\n}\n\n#overlay_heading[_ngcontent-%COMP%] {\n  color: black;\n  font-weight: bold;\n  font-size: large;\n  font-family: Arial, Helvetica, sans-serif;\n  font-variant: small-caps;\n  text-decoration: underline;\n  text-align: center;\n}\n\n#query_text_field[_ngcontent-%COMP%] {\n  width: 160px;\n  padding: 10px 10px;\n  font: x-large;\n  \n  margin-bottom: 15px;\n}\n\n\n\ninput[type=\"text\"][_ngcontent-%COMP%]\n{\n    font-size:20px;\n    font-family: Arial, Helvetica, sans-serif;\n    font-weight: bold;\n\n}\n\n#query_text_field[_ngcontent-%COMP%]:hover {\n  border: 2px solid black;\n    box-shadow: 3px 3px 3px #2C3E50;\n}\n\ninput[type=\"radio\"][_ngcontent-%COMP%]\n{\n    display: flex;\n    flex-direction: row;\n    font-size:20px;\n    font-family: Arial, Helvetica, sans-serif;\n    font-weight: bold;\n}\n\n.buttons[_ngcontent-%COMP%]{\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  border: 1px solid black;\n  box-shadow: 1px 1px 1px #2C3E50;\n}\n\n.buttons[_ngcontent-%COMP%]    > div[_ngcontent-%COMP%]{\n  margin: 10px;\n}\n\n.query-block[_ngcontent-%COMP%] {\n  margin-top: 114px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"]
    });
    /*@__PURE__*/
  ...
  /*! exports provided: URL_CONFIG, getBaseUrlConfig */
  ...
  function srcAppAppConfigTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "getBaseUrlConfig", function () {
      return getBaseUrlConfig;
    });
  ...
  function srcAppAppServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AppService = /*#__PURE__*/function () {
      ...
      _createClass(AppService, [{
        ...
        key: "getRequestData",
        value: function getRequestData(data) {
          return this.http.post(_app_config__WEBPACK_IMPORTED_MODULE_4__["URL_CONFIG"].BASE_URL + _app_config__WEBPACK_IMPORTED_MODULE_4__["URL_CONFIG"].QUERY, data, this.setRequestHeaders()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(this.extractData), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('getDataForQuery')));
        }
      }, {
        key: "getSingleTrace",
        value: function getSingleTrace() {
          return this.http.get(_app_config__WEBPACK_IMPORTED_MODULE_4__["URL_CONFIG"].BASE_URL + _app_config__WEBPACK_IMPORTED_MODULE_4__["URL_CONFIG"].TRACE, this.setRequestHeaders()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(this.extractData), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('getDataForSingleInstance')));
        }
      }, {
        key: "handleError",
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/upendra/Downloads/cloud-osa-coding-challenge/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
